    ...
    <div className='h-fit w-full p-8 flex flex-col gap-8'>
      <div className="flex justify-between">
        ...
        <div className="flex gap-4">
          <Button edgeColor="var(--color-primary)" edgeOpacity={100} edgeWidth={7}>
            docs
          </Button>
          <Button edgeColor="white" edgeOpacity={50} edgeWidth={7} className='bg-white/5 border-white/10  text-neutral-400 hover:bg-white/10'>
            code
          </Button>
        </div>
      </div>
