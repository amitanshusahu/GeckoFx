  ...
  return (
    <div className="relative">
      ...
      >
        <g id="voice-chip">
          <g id="chip-group">
            <g id="bg-glow" className={animate ? "ac-bg-glow" : ""}>
            ...
            <motion.g
              ...
              transition={float ? { duration: 5, repeat: Infinity, repeatType: "reverse", ease: "easeInOut" } : undefined}
            >
              ...
              <g id="pins">
                ...
                <circle className={animate ? "ac-pin-1" : ""} cx="213.5" cy="201.5" r="1" fill={`url(#${pId(5)})`} />
                <circle className={animate ? "ac-pin-glow-2" : ""} cx="218.5" cy="198.5" r="1" fill={`url(#${pId(6)})`} />
                <circle className={animate ? "ac-pin-2" : ""} cx="218.5" cy="198.5" r="1" fill={`url(#${pId(6)})`} />
                <circle className={animate ? "ac-pin-glow-3" : ""} cx="223.5" cy="195.5" r="1" fill={`url(#${pId(7)})`} />
                <circle className={animate ? "ac-pin-3" : ""} cx="223.5" cy="195.5" r="1" fill={`url(#${pId(7)})`} />
              </g>
              <g id="pins_2">
                <circle className={animate ? "ac-pin-glow-2" : ""} cx="1" cy="1" r="1" transform="matrix(-1 0 0 1 137.5 199.5)" fill={`url(#${pId(8)})`} />
                <circle className={animate ? "ac-pin-2" : ""} cx="1" cy="1" r="1" transform="matrix(-1 0 0 1 137.5 199.5)" fill={`url(#${pId(8)})`} />
                <circle className={animate ? "ac-pin-glow-1" : ""} cx="1" cy="1" r="1" transform="matrix(-1 0 0 1 132.5 196.5)" fill={`url(#${pId(9)})`} />
                <circle className={animate ? "ac-pin-1" : ""} cx="1" cy="1" r="1" transform="matrix(-1 0 0 1 132.5 196.5)" fill={`url(#${pId(9)})`} />
                <circle className={animate ? "ac-pin-glow-3" : ""} cx="1" cy="1" r="1" transform="matrix(-1 0 0 1 127.5 193.5)" fill={`url(#${pId(10)})`} />
                <circle className={animate ? "ac-pin-3" : ""} cx="1" cy="1" r="1" transform="matrix(-1 0 0 1 127.5 193.5)" fill={`url(#${pId(10)})`} />
              </g>
              <g id="top">
                <g id="Vector 1">
                  ...
                  <motion.path
                    ...
                    stroke={`url(#${pId(11)})`}
                    animate={animate ? { strokeOpacity: [0.55, 1, 0.55] } : undefined}
              ...
              <motion.path
                ...
                fill={c.logo}
                animate={animate ? { scale: [1, 1.06, 1], opacity: [0.92, 1, 0.92] } : undefined}
